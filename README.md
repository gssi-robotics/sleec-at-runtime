...
Generate a new test case if needed (optional):
```
python3 scalability_test_cases_generator.py --name <test_name> -r <#rules> -c <#conditions> -n <#test_cases>
```

Then run:
```
./run_scalability_tests.sh <test_name> <#rules> <#conditions> docker
```
...
#TODO: Add description of where log files are stored!

#### Start the scalability tests:
> [!NOTE]
