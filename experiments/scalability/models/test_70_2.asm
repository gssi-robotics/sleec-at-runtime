...
/* DOMAIN-GENERAL DEFINITIONS */	
	...
	rule r_Rule12 = 
		r_SLEEC[condition23, <<r_obligation23>>,
	...
	rule r_Rule14 = 
		r_SLEEC[condition27, <<r_obligation27>>,
	...
	rule r_Rule18 = 
		r_SLEEC[condition35, <<r_obligation35>>,
	...
	rule r_Rule20 = 
		r_SLEEC[condition39, <<r_obligation39>>,
	...
	rule r_Rule24 = 
		r_SLEEC[condition47, <<r_obligation47>>,
	...
	rule r_Rule30 = 
		r_SLEEC[condition59, <<r_obligation59>>,
	...
	rule r_Rule32 = 
		r_SLEEC[condition63, <<r_obligation63>>,
	...
	rule r_Rule38 = 
		r_SLEEC[condition75, <<r_obligation75>>,
	...
	rule r_Rule42 = 
		r_SLEEC[condition83, <<r_obligation83>>,
	...
	rule r_Rule44 = 
		r_SLEEC[condition87, <<r_obligation87>>,
	...
	rule r_Rule48 = 
		r_SLEEC[condition95, <<r_obligation95>>,
	...
	rule r_Rule54 = 
		r_SLEEC[condition107, <<r_obligation107>>,
	...
	rule r_Rule60 = 
		r_SLEEC[condition119, <<r_obligation119>>,
	...
	rule r_Rule62 = 
		r_SLEEC[condition123, <<r_obligation123>>,
	...
	rule r_Rule68 = 
		r_SLEEC[condition135, <<r_obligation135>>,
	...
	rule r_Rule70 = 
		r_SLEEC[condition139, <<r_obligation139>>,
